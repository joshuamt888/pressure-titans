...
const services = [
  ...
  },
  {
    ...
    description: "Holiday lighting for storefronts, offices, HOAs, and commercial properties.",
    icon: "building",
  },
];
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    {
                      title: "Fully Insured",
                      desc: "Fully insured for commercial and residential work. Your property is protected.",
                    },
                    {
              ...
              <ScrollReveal animation="fade-left" delay={200}>
                <div className="relative">
                  <ParallaxImage
                    src="/images/projects/respirator.webp"
                    alt="Pressure Titans technician with professional safety equipment"
