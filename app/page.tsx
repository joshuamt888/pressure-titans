...
const services = [
  ...
  },
  {
    ...
    href: "/services/commercial-holiday-lighting",
    icon: "building",
  },
];
            ...
            <div className="max-w-3xl">
              <ScrollReveal animation="fade-up" delay={200}>
                <div className="inline-flex items-center gap-2 bg-titan-accent/20 border border-titan-accent/30 text-titan-light text-xs sm:text-sm font-medium px-3 py-1.5 sm:px-4 sm:py-2 rounded-full mb-6">
                  ...
                  Fully Insured for Commercial and Residential Work
                </div>
              </ScrollReveal>
              ...
              <div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    {
                      title: "Fully Insured",
                      desc: "Fully insured for both commercial and residential work. Your property is protected.",
                    },
                    {
