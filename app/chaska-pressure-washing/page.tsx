...
const services = [
  {
    ...
    desc: "High-pressure cleaning for driveways, sidewalks, patios, and concrete surfaces throughout Chaska.",
    icon: (
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-slate-300 mb-8 leading-relaxed max-w-xl">
                  Keeping Chaska homes spotless along the Minnesota River Valley. From historic downtown properties to newer developments, we handle every exterior cleaning need in the Minneapolis metro.
                </p>
              ...
              <div className="hidden lg:block">
                <div className="relative aspect-[4/3] rounded-xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Pressure washing results in Chaska"
                    fill
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-4">
                Pressure Washing Services in Chaska
              </h2>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-4">
                Why Chaska Homeowners Choose Pressure Titans
              </h2>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="aspect-[4/3] rounded-xl overflow-hidden shadow-md">
                <Image
                  src="/images/projects/bafrontstepsgood.webp"
                  alt="Before and after pressure washing front steps in Chaska"
                  width={600}
                  height={450}
              ...
              <div className="aspect-[4/3] rounded-xl overflow-hidden shadow-md">
                <Image
                  ...
                  alt="Before and after deck cleaning in Chaska"
                  width={600}
                  height={450}
                  className="object-cover w-full h-full"
                />
        ...
        <section className="py-20 bg-[#0a1628]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-6">
              Get a Free Pressure Washing Quote in Chaska
            </h2>
