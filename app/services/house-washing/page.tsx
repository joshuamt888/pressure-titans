    ...
    <>
      ...
      <main>
        ...
        <section className="relative min-h-[70dvh] flex items-center bg-navy pt-20">
          <div className="absolute inset-0 bg-gradient-to-bl from-navy via-[#0d1f3c] to-navy" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center_right,_rgba(37,99,235,0.1),_transparent_50%)]" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="hidden lg:block relative">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    src="/images/projects/bahouseoutsidewallsgood.webp"
                    alt="Professional house washing before and after in Minneapolis"
                    width={600}
                    height={450}
