...
const galleryImages = [
  {
    src: "/images/projects/pw-gallery-1.webp",
    alt: "Before and after pressure washing showing clean concrete surfaces",
  },
  {
      ...
      <main>
        ...
        <section className="relative min-h-[70dvh] flex items-center bg-navy pt-20 overflow-hidden">
          <video autoPlay muted loop playsInline className="absolute inset-0 w-full h-full object-cover">
            <source src="/videos/goodsurfaceclean.mp4" type="video/mp4" />
          </video>
