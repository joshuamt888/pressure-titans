    ...
    <>
      ...
      <main>
        ...
        <section className="relative min-h-[70dvh] flex items-center bg-navy pt-20">
          <div className="absolute inset-0 bg-gradient-to-r from-navy via-navy to-[#0d1f3c]" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="hidden lg:block relative">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    src="/images/projects/badriveway.webp"
                    alt="Professional driveway pressure washing before and after in Minneapolis"
                    width={600}
                    height={450}
