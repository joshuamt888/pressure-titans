...
const galleryImages = [
  { src: "/images/projects/newholiday1.webp", alt: "Holiday lighting installation Chanhassen MN" },
  { src: "/images/projects/newholiday2.webp", alt: "Holiday lighting display Deephaven MN" },
  { src: "/images/projects/newholiday3.webp", alt: "Professional Christmas lights Deephaven" },
  { src: "/images/projects/newholiday4.webp", alt: "Holiday light installation Victoria MN" },
];
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-500 max-w-2xl mx-auto">
                Real holiday lighting installs by Pressure Titans across the Twin Cities metro.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {galleryImages.map((image) => (
                <div
                  key={image.src}
                  className="relative rounded-2xl overflow-hidden shadow-lg group aspect-[3/4]"
                >
                  <Image
                    src={image.src}
                    alt={image.alt}
