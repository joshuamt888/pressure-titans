...
const projects = [
  ...
  {
    src: "/images/projects/newdeck1.webp",
    label: "Deck Cleaning",
    alt: "Before and after deck cleaning results",
  },
  {
  ...
  {
    src: "/images/projects/newgutter1.webp",
    label: "Chanhassen",
    alt: "Before and after gutter cleaning in Chanhassen",
  },
  {
    src: "/images/projects/newgutter2.webp",
    label: "Minnetonka",
    alt: "Before and after gutter cleaning in Minnetonka",
  },
  {
    ...
    <>
      ...
      <main>
        ...
        <section className="relative bg-navy pt-20 overflow-hidden">
          <video autoPlay muted loop playsInline preload="auto" poster="/images/fullhousejob-poster.webp" className="absolute inset-0 w-full h-full object-cover">
