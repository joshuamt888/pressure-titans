...
const services = [
  {
    ...
    desc: "High-pressure cleaning for driveways, sidewalks, patios, and concrete surfaces throughout Deephaven.",
    icon: (
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <span className="inline-block bg-[#2563eb]/10 border border-[#2563eb]/20 text-[#3b82f6] text-sm font-semibold px-4 py-1.5 rounded-full mb-6">
                  Serving Deephaven, MN
                </span>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-white mb-6 leading-tight">
                  Deephaven Pressure Washing
                  <span className="block text-[#3b82f6]">& Exterior Cleaning</span>
                </h1>
                <p className="text-lg text-slate-300 mb-8 leading-relaxed max-w-xl">
                  Caring for Deephaven&apos;s elegant lakefront estates and tree-lined residential streets. We provide meticulous exterior cleaning that matches the quality of your Minneapolis metro property.
                </p>
              ...
              <div className="hidden lg:block">
                <div className="relative aspect-[4/3] rounded-xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Pressure washing results in Deephaven"
                    fill
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-4">
                Pressure Washing Services in Deephaven
              </h2>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-4">
                Why Deephaven Homeowners Choose Pressure Titans
              </h2>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="aspect-[4/3] rounded-xl overflow-hidden shadow-md">
                <Image
                  src="/images/projects/bafrontstepsgood.webp"
                  alt="Before and after pressure washing front steps in Deephaven"
                  width={600}
                  height={450}
              ...
              <div className="aspect-[4/3] rounded-xl overflow-hidden shadow-md">
                <Image
                  ...
                  alt="Before and after deck cleaning in Deephaven"
                  width={600}
                  height={450}
                  className="object-cover w-full h-full"
                />
        ...
        <section className="py-20 bg-[#0a1628]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-6">
              Get a Free Pressure Washing Quote in Deephaven
            </h2>
